module only_on_aptos::migration_helper {
    ...
    const MIGRATION_CONTRACT_SEED: vector<u8> = b"only_on_aptos::migration_contract";

    #[view]
    /// Helper function to get the address of the migration object signer.
    public fun migration_object_address(): address {
        object::create_object_address(&@only_on_aptos, MIGRATION_CONTRACT_SEED)
    }
